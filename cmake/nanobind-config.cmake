...
function (nanobind_add_stub name)
  cmake_parse_arguments(PARSE_ARGV 1 ARG "VERBOSE;INCLUDE_PRIVATE;EXCLUDE_DOCSTRINGS;EXCLUDE_VALUES;INSTALL_TIME;RECURSIVE;EXCLUDE_FROM_ALL" "MODULE;COMPONENT;PATTERN_FILE;OUTPUT_PATH" "PYTHON_PATH;DEPENDS;MARKER_FILE;OUTPUT;MODULE_DEP")
  ...
  foreach (MODULE_DEP IN LISTS ARG_MODULE_DEP)
    list(APPEND NB_STUBGEN_ARGS --dep "${MODULE_DEP}")
  endforeach()
