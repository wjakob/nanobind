...
/**
 *\brief Strategies to cast an unknown C++ object to Python.
 *
 *`The helper `rv_policy::policy_tag<V>`` tags policies at compile time,
 * while also implicitly converting to the runtime ``rv_policy::value``.
 */
